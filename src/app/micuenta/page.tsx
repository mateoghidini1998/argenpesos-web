            ...
            <section className="w-full h-full flex flex-col items-center justify-center mt-[200px]">
                ...
                <div className="flex flex-col md:flex-row items-center justify-center md:w-[800px] gap-8 md:gap-[100px] mb-[50px] md:mb-32">
                    <Link href="http://clientes.argenpesos.com.ar:5003/registration" target="__blank"
                        className="flex w-[200px] h-[40px] text-base  md:w-[450px] md:h-[100px] justify-center items-center hover:bg-lightblue-primary hover:text-white hover:bg-[#00ADEE] transition duration-200 md:py-5 md:px-6 rounded-[8px] py-[20px] px-[40px] md:rounded-[38px] border-[#00ADEE] border-[1px] md:border-[3px] border-solid text-lightblue-primary md:text-[32px] text-center"
                    >
                        Crear Usuario
                    </Link>
                    <Link href="http://clientes.argenpesos.com.ar:5003/login" target="__blank"
                        className="flex w-[200px] h-[40px] leading-normal text-base  md:w-[450px] md:h-[100px] justify-center items-center hover:bg-lightblue-primary hover:text-white hover:bg-[#00ADEE] transition duration-200 md:py-3 md:px-6 rounded-[8px] py-[20px] px-[40px] md:rounded-[38px] border-[#00ADEE] border-[1px] md:border-[3px] border-solid text-lightblue-primary md:text-[32px] text-center">
                        Iniciar Sesión
                    </Link>
                </div>
                <div className="grid grid-cols-2 md:flex md:flex-wrap items-center justify-center md:px-24 gap-[42px] md:gap-[160px] mb-32">
                    <div className="flex flex-col items-center justify-center ">
                         ...
                         <div className="flex items-center justify-center mt-[40px]">
                            <ChevronRight className="text-lightblue-primary"/>
                            <p className="text-lightblue-primary leading-normal  text-base md:text-[32px]  text-center">Crear usuario</p>
                         </div>
                    </div>
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <div className="flex items-center justify-center mt-[40px]">
                            <ChevronRight className="text-lightblue-primary"/>
                            <p className="text-lightblue-primary leading-normal text-base md:text-[32px] text-center">Ingresá</p>
                        </div>
                    </div>
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <div className="flex items-center justify-center mt-[40px]">
                            <ChevronRight className="text-lightblue-primary"/>
                            <p className="text-lightblue-primary leading-normal text-base md:text-[32px] text-center">Mirá tus créditos</p>
                        </div>
                    </div>
                    <div className="flex flex-col items-center justify-center">
                        ...
                        <div className="flex items-center justify-center mt-[40px]">
                            <ChevronRight className="text-lightblue-primary"/>
                            <p className="text-lightblue-primary leading-normal text-base md:text-[32px] text-center">Paga tus cuotas</p>
                        </div>
                    </div>
                </div>
            </section>
