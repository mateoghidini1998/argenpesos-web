                ...
                <div className="flex flex-col md:flex-row items-center justify-around w-full h-full bg-gradient-to-t pt-8 from-[#5AD2F7] to-[#4DC4F1] rounded-[30px]">
                    <div className="h-full w-[45%] flex flex-col  items-center  md:px-12 pb-0 md:py-14 ">
                        <div className="flex flex-col items-start justify-center">
                            ...
                            <h2 className="text-white text-center md:text-start w-auto text-[18px] md:text-[30px] xl:text-[40px] mb-[20px] sm:leading-[2rem]">¿Todavía no descargaste la app de ArgenPesos?</h2>
                            <p className="text-white text-center md:text-start w-auto text-base md:text-[16px] xl:text-[24px] mb-[10px] md:mb-[55px] font-medium">Recibe préstamos, compra productos, obtén descuentos y más beneficios.</p>
                        </div>
                        <div className="flex flex-col md:flex-row w-full items-center justify-start gap-[20px]">
