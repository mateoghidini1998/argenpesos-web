...
const METODOS_DE_PAGO = [
    { 
      title: "Pago Facil",
       ...
       description2: "Ingresá a https://www.pagofacil.com.ar/ para encontrar la sucursal más cercana.", 
       description3: "Para abonar la cuota de tu préstamo de manera online deberás ingresar a https://www.e-pagofacil.com/", 
    ...
    { 
      title: "Rapi Pago",
       image: RapiPago,
       description1:  "Para abonar la cuota de tu préstamo por Rapipago deberás asistir de manera presencial a cualquier sucursal (ingresá a https://rapipago.com.ar para encontrar la sucursal más cercana). Deberás realizar un pago abierto a empresa sin factura a nombre de Argencred S.A o Argenpesos. ", 
