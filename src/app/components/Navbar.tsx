...
export default function Navbar({ onNavbarToggle }) {
    ...
    const LINKS = [ 
        { "text": "Inicio", "url": "/" },
        { "text": "Argencompras", "url": "https://www.argencompras.com.ar" },
        { "text": "Cuponizate", "url": "https://cuponizate.com.ar/" },
        ...
        { "text": "Contactanos", "url": "https://api.whatsapp.com/send?phone=541168164074&text=Hola!%20les%20consulto%20por%20los%20servicios%20vistos%20en%20www.argenpesos.com.ar" },
    ];
    ...
    return (
        <nav className={`relative ${isOpen ? 'w-full h-full fixed inset-0 bg-white z-99 flex flex-col items-center ' : 'relative'}`}>
            ...
            <div className={`${isOpen ? 'flex flex-col  flex-1 justify-center lg:flex-row' : 'hidden lg:flex'} lg:items-center gap-8 md:gap-2 lg:gap-4 xl:gap-8 w-full`}>
                <div className="mb-[50px] block lg:hidden mx-auto" >
                    <img src="./logo.png" alt="argenpesos" className=" w-[150px] h-[80px] " />
                </div>
